...
async def main():
    ...
    if args.list_tools or args.list_plugins or args.demo:
        server_instance = ChiaMCPServer(host=args.host, port=args.port, chia_rpc_port=args.chia_rpc_port)
...
async def show_demo(server: ChiaMCPServer) -> None:
    ...
    print("   Features: Hierarchical tools, Plugin system, Categories")
    print()
