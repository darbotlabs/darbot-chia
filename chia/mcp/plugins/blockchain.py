...
class BlockchainPlugin(MCPPlugin):
        ...
        self.add_tool(
            MCPTool(
                ...
                input_schema={
                    ...
                    "examples": [{"include_connections": True, "include_mempool": True}],
                },
            )
        )
        ...
        self.add_tool(
            MCPTool(
                ...
                input_schema={
                    "type": "object",
                    "properties": {
                        "height": {"type": "integer", "description": "Block height to retrieve", "minimum": 0},
                    ...
                    "required": ["height"],
                    "examples": [{"height": 4123456, "include_transactions": False}],
                },
            )
        )
        ...
        self.add_tool(
            MCPTool(
                ...
                input_schema={
                    ...
                    "examples": [{"header_hash": "0x1a2b3c4d5e6f..."}],
                },
            )
        )
        ...
        self.add_tool(
            MCPTool(
                ...
                input_schema={
                    "type": "object",
                    "properties": {
                        "start_height": {"type": "integer", "description": "Starting block height", "minimum": 0},
                        "end_height": {"type": "integer", "description": "Ending block height", "minimum": 0},
                        "include_transactions": {
                            "type": "boolean",
                    ...
                    "examples": [{"start_height": 4123400, "end_height": 4123410}],
                },
            )
        )
    ...
    async def _get_block_range(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for height in range(start_height, end_height + 1):
            try:
                block_data = await self._get_block_by_height({"height": height, "include_transactions": include_tx})
    ...
    async def _get_peak_block(self) -> Dict[str, Any]:
        ...
        return {"peak": peak, "height": peak.get("height", 0), "timestamp": self._get_current_timestamp()}
