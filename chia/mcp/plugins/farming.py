...
class FarmingPlugin(MCPPlugin):
        ...
        self.add_tool(
            MCPTool(
                ...
                input_schema={
                    ...
                    "examples": [{"group_by_size": True, "include_directories": False}],
                },
            )
        )
        ...
        self.add_tool(
            MCPTool(
                ...
                input_schema={
                    "type": "object",
                    "properties": {
                        "plot_id": {"type": "string", "description": "Specific plot ID to get details for (optional)"},
                        "directory": {"type": "string", "description": "Filter plots by directory path (optional)"},
                        "k_size": {
                            "type": "integer",
                    ...
                    "examples": [{"k_size": 32, "limit": 50}, {"directory": "/plots/ssd1/"}],
                },
            )
        )
    ...
    async def _get_plot_details(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "filters_applied": {"plot_id": plot_id, "directory": directory, "k_size": k_size},
            "timestamp": self._get_current_timestamp(),
        }
                ...
                if check_duplicates:
                    if plot_id in seen_ids:
                        ...
                        health_issues.append(
                            {"type": "duplicate_plot_id", "plot_id": plot_id, "filename": plot.get("filename")}
                        )
                    else:
