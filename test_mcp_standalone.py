...
def test_protocol():
    ...
    resource = MCPResource(
        uri="test://resource", name="Test Resource", description="A test resource", mime_type="application/json"
    )
        ...
        },
        {
            ...
            "input_schema": {
                ...
                "properties": {
                    ...
                    "start": {"type": "integer", "description": "Starting index for transactions", "default": 0},
                    "end": {"type": "integer", "description": "Ending index for transactions", "default": 50},
                },
            },
        },
    ]
